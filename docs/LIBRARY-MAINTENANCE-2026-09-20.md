...
- A NAS may retain deleted files in its own recycle bin or snapshots. Gumbo offers no undo for a delete, and does not erase backups or device downloads.
