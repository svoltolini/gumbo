...
Catalogue snapshots have a monotonic revision within each authorization, so an older transfer cannot overwrite a newer artwork or deletion update. Revision and generation time do not affect content deduplication.
